...
exports.run = async function ({ client, msg, args }) {
    ...
    if (res.type !== 'search') {
        ...
        const src = await msg.channel.createMessage({ embed: {
            ...
            footer: {
                text: 'Select 1 - 10 || c to cancel selection'
            }
        } });
        ...
        src.edit({ embed: {
            color: client.config.options.embedColour,
            title: `<:checked:531233357787561984> Enqueued ${res.items[selected.content - 1].snippet.title}`,
            thumbnail: {"url": `https://i.ytimg.com/vi/${res.items[selected.content - 1].id.videoId}/default.jpg?width=80&height=60`},
